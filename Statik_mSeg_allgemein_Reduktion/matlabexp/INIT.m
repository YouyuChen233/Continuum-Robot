...
pars.nseil=4;
pars.same=6;
pars.nsame=zeros(1,pars.same+1);
for i=1:(pars.same+1)
    pars.nsame(i)=pars.ndsk/pars.same*(i-1);
end
pars.m=1.699e-3*ones(1,pars.ndsk); %Masse des Disks
...
pars.tau(1)=1;    pars.psi(1)=0;%+pi/4;
...
pars.diffL(1)=0;
pars.diffL(2)=-0.0244649703625130;
pars.diffL(3)=0;
pars.diffL(4)=0;
pars.diffL(5)=0;
pars.diffL(6)=0;
